...
angular.module('botb.services', [])
    ...
    .factory('Quizzes', function () {
        ...
        return {
            ...
            get: function (quizId) {
                var i = 0;
                for (i; i < quizzes.length; i++) {
                    if (quizzes[i].id === parseInt(quizId, 10)) {
                        return quizzes[i];
                    }
                }
                return null;
        ...
        return {
            ...
            randomSelection : function (correctBookIndex, numberDesired) {
                ...
                var id,
                    ...
                    selection = [],
                    previousBookIndex = 0,
                    randomPosForCorrectBook = randomIntFromInterval(0, 4);
                if (correctBookIndex > 0) {
                    previousBookIndex = correctBookIndex - 1;
                }
                try {
                    for (i; i < numberDesired; i++) {
                        do {
                            id = randomIntFromInterval(0, 65);
                        } while (selection.indexOf(books[id]) > -1 || id === previousBookIndex);
            ...
            get: function (bookId) {
                ...
                for (i; i < books.length; i++) {
                    if (books[i].id === parseInt(bookId, 10)) {
                        return books[i];
                    }
                }
                return null;
